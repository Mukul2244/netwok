      ...
      <div className="container relative z-10 mx-auto">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl">
            We&apos;re on a mission to transform how people connect in physical
            spaces, making every venue a hub for meaningful interactions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-24">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg">
              <p>
                Netwok was founded in 2022 by a team of tech enthusiasts who
                were frustrated by the paradox of modern social life: we&apos;re
                more connected than ever digitally, yet increasingly isolated in
                physical spaces.
              </p>
              <p>
                Our founders noticed how people in cafes, bars, and events were
                often surrounded by others with similar interests, yet remained
                strangers. They envisioned a platform that could bridge this
                gap, helping people connect meaningfully in physical spaces
                while respecting privacy and personal boundaries.
              </p>
              <p>
                After months of development and testing in various venues across
                San Francisco, Netwok was born – a platform that transforms how
                people connect in physical spaces, making every venue a hub for
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            We&apos;re guided by a set of core principles that shape everything
            we do.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          <div className="bg-background/40 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/10 hover:border-purple-500/30 transition-all hover:shadow-2xl hover:shadow-purple-600/10 group">
            ...
            <p className="text-muted-foreground">
              We believe technology should enhance real-world interactions, not
              replace them. Our platform is designed to facilitate genuine
              connections between people in physical spaces.
            </p>
          </div>
          <div className="bg-background/40 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/10 hover:border-blue-500/30 transition-all hover:shadow-2xl hover:shadow-blue-600/10 group">
            ...
            <p className="text-muted-foreground">
              We respect user privacy and give individuals control over their
              information. Our platform is built with privacy at its core,
              ensuring users only share what they&apos;re comfortable with.
            </p>
          </div>
          <div className="bg-background/40 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/10 hover:border-pink-500/30 transition-all hover:shadow-2xl hover:shadow-pink-600/10 group">
            ...
            <p className="text-muted-foreground">
              We&apos;re committed to helping venues create vibrant communities.
              By facilitating connections between visitors, we help transform
              spaces into thriving social hubs.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            The passionate individuals behind Netwok who are dedicated to
