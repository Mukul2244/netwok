      ...
      <div className="container relative z-10 mx-auto">
        ...
        <div className="bg-background/40 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-white/10 mb-16">
          <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-purple-600 hover:prose-a:text-purple-500 prose-a:no-underline">
            <h2>Introduction</h2>
            <p>
              This Cookie Policy explains how Netwok, Inc. (&quot;Netwok,&quot;
              ...
              &quot;Service&quot;). It explains what these technologies are and
            ...
            <p>
              Cookies set by the website owner (in this case, Netwok) are called
            ...
            <p>
              ...
              enhance the experience on our Service. Third parties serve cookies
              through our Service for advertising, analytics, and other
              purposes.
            </p>
            <p>
            ...
            <p>
              ...
              someone has visited our Service or opened an email that we have
              sent them. This allows us, for example, to monitor the traffic
              patterns of users from one page within our Service to another, to
              deliver or communicate with cookies, to understand whether you
              have come to our Service from an online advertisement displayed on
            ...
            <p>
              Our Service may also use so-called &quot;Flash Cookies&quot; (also
            ...
            <p>
              ...
              to evaluate your use of the Service, compile reports on activity,
              collect demographic data, analyze performance metrics, and collect
              and evaluate other information relating to the Service and mobile
              and internet usage. These third parties use cookies and other
              technologies to help analyze and provide us the data. By accessing
              and using the Service, you consent to the processing of data about
