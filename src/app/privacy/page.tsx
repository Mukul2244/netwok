          ...
          <div className="container relative z-10 mx-auto">
            ...
            <div className="bg-background/40 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-white/10 mb-16">
              <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-purple-600 hover:prose-a:text-purple-500 prose-a:no-underline">
                <h2>Introduction</h2>
                <p>
                  At Netwok, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose,
                  and safeguard your information when you use our mobile application and website (collectively, the
                  &quot;Service&quot;).
                </p>
                <p>
                  Please read this Privacy Policy carefully. By accessing and using our Service, you acknowledge that
                ...
                <ul>
                  <li>
                    ...
                    such as your name, email address, and profile information that you choose to share.
                  </li>
                  <li>
                    <strong>Location Information:</strong> With your consent, we collect your location information when
                    you use our Service to connect you with others at the same venue.
                  </li>
                  <li>
                    <strong>Usage Information:</strong> We collect information about how you use our Service, including
                    your interactions with other users, venues you visit, and features you use.
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>Connect you with other users at the same venue based on your preferences</li>
                  <li>Personalize your experience and deliver content relevant to your interests</li>
                  <li>Communicate with you about updates, promotions, and other news about our Service</li>
                ...
                <ul>
                  <li>
                    <strong>With Other Users:</strong> When you use our Service, certain information (such as your
                    profile information and interests) may be visible to other users at the same venue.
                  </li>
                  <li>
                    <strong>With Venue Partners:</strong> We may share aggregated, anonymized data with venue partners
                    to help them understand user engagement and improve their services.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>For Legal Reasons:</strong> We may disclose your information if required by law or in
                    response to valid requests by public authorities.
                  </li>
                </ul>

                <h2>Your Privacy Choices</h2>
                <p>We respect your privacy choices and provide you with control over your information:</p>
                <ul>
                  <li>
                    <strong>Profile Information:</strong> You can update or delete your profile information at any time
                    through the app settings.
                  </li>
                  <li>
                    <strong>Location Permissions:</strong> You can enable or disable location permissions through your
                    device settings.
                  </li>
                  <li>
                    <strong>Communication Preferences:</strong> You can opt out of receiving promotional communications
                    from us by following the unsubscribe instructions in our emails.
                  </li>
                  <li>
                    <strong>Account Deletion:</strong> You can request to delete your account and associated data by
                    contacting us at privacy@netwok.com.
                  </li>
                </ul>
