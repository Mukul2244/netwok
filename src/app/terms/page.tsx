          ...
          <div className="container relative z-10 mx-auto">
            ...
            <div className="bg-background/40 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-white/10 mb-16">
              <div className="prose prose-lg max-w-none prose-headings:font-bold prose-headings:text-foreground prose-p:text-muted-foreground prose-a:text-purple-600 hover:prose-a:text-purple-500 prose-a:no-underline">
                ...
                <p>
                  By accessing or using the Netwok mobile application and website (collectively, the &quot;Service&quot;), you
                  agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do
                  not use the Service.
                </p>
                <p>
                  These Terms constitute a legally binding agreement between you and Netwok, Inc. (&quot;Netwok,&quot; &quot;we,&quot; &quot;us,&quot;
                ...
                <p>
                  ...
                  that you are 18 years of age or older and have the legal capacity to enter into these Terms.
                </p>
                ...
                <ul>
                  ...
                  <li>Harass, abuse, or harm another person, or to threaten to do any of the foregoing</li>
                  <li>
                  ...
                  <li>
                    Use the Service to send unsolicited communications, promotions, or advertisements, or to spam,
                    phish, or pharm other users
                  </li>
                  <li>
                  ...
                  <li>Attempt to gain unauthorized access to the Service or to other users&apos; accounts</li>
                </ul>

                <h2>6. Venue Partners</h2>
                <p>
                  The Service allows venue owners and operators (&quot;Venue Partners&quot;) to create digital networks for their
                  physical spaces. Venue Partners are responsible for complying with all applicable laws and regulations
                  related to their use of the Service.
                </p>
                <p>
                  Netwok does not endorse any Venue Partner and is not responsible for the conduct of any Venue Partner
                  or the quality of their services.
                </p>

                <h2>7. Intellectual Property</h2>
                <p>
                  The Service and its original content, features, and functionality are owned by Netwok and are
                  protected by international copyright, trademark, patent, trade secret, and other intellectual property
                  or proprietary rights laws.
                </p>
                <p>
                  You may not copy, modify, create derivative works of, publicly display, publicly perform, republish,
                  or transmit any of the material on our Service, or distribute or otherwise use the Service in any way
                  for any public or commercial purpose without our prior written consent.
                </p>

                <h2>8. User Content</h2>
                <p>
                  The Service may allow you to post, link, store, share, and otherwise make available certain
                  information, text, graphics, videos, or other material (&quot;User Content&quot;). You are responsible for the
                  User Content that you post on or through the Service, including its legality, reliability, and
                  appropriateness.
                </p>
                <p>
                ...
                <p>
                  ...
                  by reference. Please review our <Link href="/privacy">Privacy Policy</Link> to understand our
                  practices.
                </p>
                ...
                <p>
                  In no event shall Netwok, nor its directors, employees, partners, agents, suppliers, or affiliates, be
